  ...
  return (
    ...
    <div className='container font-sans text-xl max-w-full h-fit'>
        ...
        <div id='right-nav'>
            ...
            <button onClick={handleMenuClick} style={{display: menuOpen ? 'none' : 'flex'}}><ion-icon id="open" name="menu"></ion-icon></button>            
            <button id="close" onClick={handleCloseClick} style={{display: menuOpen ? 'flex' : 'none'}}><ion-icon name="close"></ion-icon></button>
        </div>
    </div>
